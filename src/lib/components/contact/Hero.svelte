  ...
  <div class="relative max-w-6xl mx-auto px-6 md:px-20">
    ...
    <div class="max-w-3xl">
      ...
      <h1 class="text-[42px] md:text-[80px] leading-tight font-semibold">
        ...
        <span class="text-lime-400">that actually works.</span>
      </h1>

      <!-- 🔥 SUBTEXT -->
      <p class="text-gray-400 mt-6 text-lg max-w-xl leading-relaxed">
        Tell us about your project, goals, or challenges — we’ll guide you with the right strategy, not just a quote.
      </p>
